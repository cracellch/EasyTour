<%-- 
    Document   : adminToursCa
    Created on : 5/05/2019, 01:05:32 PM
    Author     : usuario1
--%>
  ...
  <%
    ...
    if (sesion.getAttribute("autenticado") != null && sesion.getAttribute("tipo").equals("admin") && request.getMethod() == "GET") {
        try {
          ...
          ArrayList<Tour> array = con.getToursC();
          Gson gson = new Gson();
 %>
  ...
  <body>
    ...
    <div class="row">
      <div class="col s12 m12 l12">
        <div class="container">
          <div class="row">
            <h2 class="center col s12 m12 l12" id="Ptitle">Tours Cancelados</h2>
          </div>
          <div class="row">
               <div class="col s12">
                 <ul class="tabs tabs-fixed-width tabs-transparent" id="ctabs">
                   ...
                   <li class="tab col s3" id="bgt"><a href="#" class="active" id="tta">Tours cancelados</a></li>
                   <li class="tab col s3" id="bgt"><a href="adminToursRe.jsp" id="tt">Tours realizados</a></li>
                 </ul>
               </div>
          </div>
